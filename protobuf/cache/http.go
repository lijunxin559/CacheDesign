...
type HTTPPool struct {
	...
	peers       *consistanthash.Map    //lay on the circle
...
//set the peers on the circle
func (p *HTTPPool) Set(peers ...string) {
	p.mu.Lock()
	defer p.mu.Unlock()
	p.peers = consistanthash.New(defaultReplicas, nil) //hashfunc is default
	p.peers.Add(peers...)
